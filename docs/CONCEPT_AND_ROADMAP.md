## MindSync – Konzept, Wissenschaft & Roadmap

Dieses Dokument bündelt die konzeptionellen, wissenschaftlichen und roadmap-bezogenen Inhalte aus der `README.md`, um die Haupt-README schlank und entwicklerfreundlich zu halten.
...
- **Ziel**: Veränderte Bewusstseinszustände, Kreativität, Trancezustand
...
- [ ] **HomeKit Integration**: Philips Hue, Nanoleaf für raumweite Synchronisation
...
## 🏗️ Architektur-Deep-Dive (Kurzüberblick)

Details zur Implementierung finden sich zusätzlich in `docs/ARCHITECTURE.md` und `docs/SYNC_IMPLEMENTATION.md`. Hier ein komprimierter Überblick.
...
### Entrainment-Algorithmus (vereinfachtes Pseudocode-Beispiel)
